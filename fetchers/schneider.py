...
class SchneiderFetcher(CompanyFetcher):
    """施耐德電機 爬蟲"""

    company_id = "schneider"
    company_name = "施耐德電機"
    news_url = "https://www.施耐德電機.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 施耐德電機")
        return documents
