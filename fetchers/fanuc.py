...
class FanucFetcher(CompanyFetcher):
    """發那科 爬蟲"""

    company_id = "fanuc"
    company_name = "發那科"
    news_url = "https://www.發那科.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 發那科")
        return documents
