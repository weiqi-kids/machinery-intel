...
class DmgMoriFetcher(CompanyFetcher):
    """德馬吉森精機 爬蟲"""

    company_id = "dmg_mori"
    company_name = "德馬吉森精機"
    news_url = "https://www.德馬吉森精機.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 德馬吉森精機")
        return documents
