...
class RockwellFetcher(CompanyFetcher):
    """Rockwell Automation 爬蟲"""

    company_id = "rockwell"
    company_name = "Rockwell Automation"
    news_url = "https://www.rockwellautomation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Rockwell Automation")
        return documents
