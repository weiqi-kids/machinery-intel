...
class HiwinFetcher(CompanyFetcher):
    """上銀科技 爬蟲"""

    company_id = "hiwin"
    company_name = "上銀科技"
    news_url = "https://www.上銀科技.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 上銀科技")
        return documents
