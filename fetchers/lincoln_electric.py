...
class LincolnElectricFetcher(CompanyFetcher):
    """Lincoln Electric 爬蟲"""

    company_id = "lincoln_electric"
    company_name = "Lincoln Electric"
    news_url = "https://www.lincolnelectric.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lincolnelectric.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lincoln Electric")
        return documents
...
if __name__ == "__main__":
    fetcher = LincolnElectricFetcher()
