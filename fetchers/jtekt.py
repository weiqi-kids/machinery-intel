...
class JtektFetcher(CompanyFetcher):
    """捷太格特 爬蟲"""

    company_id = "jtekt"
    company_name = "捷太格特"
    news_url = "https://www.捷太格特.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 捷太格特")
        return documents
