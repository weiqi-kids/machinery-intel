...
class TongtaiFetcher(CompanyFetcher):
    """東台精機 爬蟲"""

    company_id = "tongtai"
    company_name = "東台精機"
    news_url = "https://www.東台精機.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 東台精機")
        return documents
