...
class AirtacFetcher(CompanyFetcher):
    """亞德客國際 爬蟲"""

    company_id = "airtac"
    company_name = "亞德客國際"
    news_url = "https://www.亞德客國際.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 亞德客國際")
        return documents
