...
class ParkerHannifinFetcher(CompanyFetcher):
    """Parker Hannifin 爬蟲"""

    company_id = "parker_hannifin"
    company_name = "Parker Hannifin"
    news_url = "https://www.parkerhannifin.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.parkerhannifin.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Parker Hannifin")
        return documents
