...
class KeyenceFetcher(CompanyFetcher):
    """基恩斯 爬蟲"""

    company_id = "keyence"
    company_name = "基恩斯"
    news_url = "https://www.基恩斯.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 基恩斯")
        return documents
