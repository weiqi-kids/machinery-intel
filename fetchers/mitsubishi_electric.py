...
class MitsubishiElectricFetcher(CompanyFetcher):
    """三菱電機 爬蟲"""

    company_id = "mitsubishi_electric"
    company_name = "三菱電機"
    news_url = "https://www.三菱電機.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 三菱電機")
        return documents
...
if __name__ == "__main__":
    fetcher = MitsubishiElectricFetcher()
