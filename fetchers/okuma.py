...
class OkumaFetcher(CompanyFetcher):
    """大隈 爬蟲"""

    company_id = "okuma"
    company_name = "大隈"
    news_url = "https://www.大隈.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 大隈")
        return documents
