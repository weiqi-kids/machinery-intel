...
class GoodwayFetcher(CompanyFetcher):
    """程泰機械 爬蟲"""

    company_id = "goodway"
    company_name = "程泰機械"
    news_url = "https://www.程泰機械.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 程泰機械")
        return documents
