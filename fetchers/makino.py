...
class MakinoFetcher(CompanyFetcher):
    """牧野 爬蟲"""

    company_id = "makino"
    company_name = "牧野"
    news_url = "https://www.牧野.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 牧野")
        return documents
