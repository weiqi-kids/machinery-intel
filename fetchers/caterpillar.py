...
class CaterpillarFetcher(CompanyFetcher):
    """Caterpillar 爬蟲"""

    company_id = "caterpillar"
    company_name = "Caterpillar"
    news_url = "https://www.caterpillar.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.caterpillar.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Caterpillar")
        return documents
