...
class ItwFetcher(CompanyFetcher):
    """Illinois Tool Works 爬蟲"""

    company_id = "itw"
    company_name = "Illinois Tool Works"
    news_url = "https://www.illinoistoolworks.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.illinoistoolworks.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Illinois Tool Works")
        return documents
