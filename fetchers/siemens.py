...
class SiemensFetcher(CompanyFetcher):
    """西門子 爬蟲"""

    company_id = "siemens"
    company_name = "西門子"
    news_url = "https://www.西門子.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 西門子")
        return documents
