...
class AmadaFetcher(CompanyFetcher):
    """天田 爬蟲"""

    company_id = "amada"
    company_name = "天田"
    news_url = "https://www.天田.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 天田")
        return documents
